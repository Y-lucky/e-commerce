<template>
  <div class="login">
      ...
      <div class="login-decem">注册Decem</div>
      <el-form ref="loginFormRef" :model="loginFrom" :rules="loginFromRules">
        ...
        <!-- 登入 -->
        <el-form-item >
          <el-button type="primary" round class="log-in" @click="registerClick">注册</el-button>
          <!-- <span class="forget-password">忘记密码？</span> -->
        </el-form-item>
        <!-- 注册 -->
         <el-form-item class="no-account">
            <span>已有账号</span>
            <el-button type="primary" round class="registered" @click="$router.push('/login')">登入</el-button>
        </el-form-item>
...
export default {
    ...
    methods: {
      // 表单的预验证
     async registerClick(){
        const res =  await this.$http.post('/register',this.loginFrom)
